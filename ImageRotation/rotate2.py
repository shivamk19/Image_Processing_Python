...
rotation_in_degree=int(input("Enter the angle in degree by which the photo should be rotated: ")) 
...
#Maximum Length of the output_image
...
mid_col=int((rotated_width+1)/2) #Applying Rotation Matrix [[cos(theta) -sin(theta)
                                                        # sin(theta) cos(theta)]]
